...
5. Avvia MariaDB e il broker MQTT, poi avvia il server:
...
Non è previsto al momento un ambiente di test o linting separato oltre alle dipendenze elencate in [Dipendenze](#dipendenze). Per proporre modifiche è sufficiente seguire i passaggi della sezione [Come installare](#come-installare).
...
Il progetto è a scopo didattico e non è distribuito in produzione pubblica. Eventuali vulnerabilità individuate (vedi anche [Limitazioni note](#limitazioni-note-e-possibili-miglioramenti)) possono essere segnalate direttamente agli autori del progetto.
